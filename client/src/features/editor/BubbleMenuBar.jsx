function Button({ children, onClick, active }) {
    return (
        <button
            ...
            onClick={onClick}
            className={`px-3 py-1 text-sm rounded-lg transition hover:cursor-pointer ${
                active
                    ? "bg-black text-white"
...
export default function BubbleMenuBar({ editor }) {
    ...
    return (
        <div className="flex items-center gap-1 bg-black text-white rounded-xl shadow-2xl p-2 cursor-pointer">
